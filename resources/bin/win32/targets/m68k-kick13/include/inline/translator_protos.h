...
LONG __Translate(__reg("a6") void *, __reg("a0") const STRPTR inputString, __reg("d0") LONG inputLength, __reg("a1") STRPTR outputBuffer, __reg("d1") LONG bufferSize)="\tjsr\t-30(a6)";
