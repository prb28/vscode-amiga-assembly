...
return view['_get'+type](view._start+byteOffset,littleEndian)}}})(dataType,this)}}};if(compatibility.NodeBuffer){jDataView.createBuffer=function(){var buffer=new Buffer(arguments.length);for(var i=0;i<arguments.length;++i){buffer[i]=arguments[i]}
