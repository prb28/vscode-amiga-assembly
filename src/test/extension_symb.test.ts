...
describe("Global Extension Tests", function () {
    context("Symbols commands", function () {
        ...
        it("Should find a symbol definition", async () => {
            let locations = await vscode.commands.executeCommand('vscode.executeDefinitionProvider', uri, new Position(343, 33));
            // tslint:disable-next-line:no-unused-expression
        ...
        it("Should find all the symbol references", async () => {
            let locations = await vscode.commands.executeCommand('vscode.executeReferenceProvider', uri, new Position(343, 33));
            // tslint:disable-next-line:no-unused-expression
            expect(locations).to.not.be.undefined;
            if (locations) {
                let l = locations as Array<Location>;
        ...
        it("Should find all the symbol references for symbol in calculus", async () => {
            let locations = await vscode.commands.executeCommand('vscode.executeReferenceProvider', uri, new Position(302, 41));
            // tslint:disable-next-line:no-unused-expression
            expect(locations).to.not.be.undefined;
            if (locations) {
                let l = locations as Array<Location>;
        ...
        it("Should find all the symbol references for a dot label", async () => {
            let locations = await vscode.commands.executeCommand('vscode.executeReferenceProvider', uri, new Position(119, 5));
            // tslint:disable-next-line:no-unused-expression
            expect(locations).to.not.be.undefined;
            if (locations) {
                let l = locations as Array<Location>;
        ...
        it("Should find all the symbol references for a strange label", async () => {
            let locations = await vscode.commands.executeCommand('vscode.executeReferenceProvider', uri, new Position(216, 5));
            // tslint:disable-next-line:no-unused-expression
            expect(locations).to.not.be.undefined;
            if (locations) {
                let l = locations as Array<Location>;
